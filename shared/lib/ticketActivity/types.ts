...
export const TICKET_ACTIVITY_EVENT = {
  ...
  BUNDLE_STATUS_PROPAGATED: 'TICKET_BUNDLE_STATUS_PROPAGATED',
  BUNDLE_CHILD_ADDED: 'TICKET_BUNDLE_CHILD_ADDED',
  CHECKLIST_ITEM_COMPLETED: 'TICKET_CHECKLIST_ITEM_COMPLETED',
  CHECKLIST_ITEM_UNCOMPLETED: 'TICKET_CHECKLIST_ITEM_UNCOMPLETED',
  CHECKLIST_TEMPLATE_APPLIED: 'TICKET_CHECKLIST_TEMPLATE_APPLIED',
  CLOSE_RULES_OVERRIDDEN: 'TICKET_CLOSE_RULES_OVERRIDDEN',
  CLOSE_RULES_BYPASSED: 'TICKET_CLOSE_RULES_BYPASSED',
  AUTO_CLOSE_WARNING_SENT: 'TICKET_AUTO_CLOSE_WARNING_SENT',
