...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: /^@alga-psa\/list-views$/, replacement: path.resolve(__dirname, '../packages/list-views/src/index.ts') },
      { find: /^@alga-psa\/list-views\/(actions|components|hooks)$/, replacement: path.resolve(__dirname, '../packages/list-views/src/$1/index.ts') },
      { find: /^@alga-psa\/list-views\/(.*)$/, replacement: path.resolve(__dirname, '../packages/list-views/src/$1') },
