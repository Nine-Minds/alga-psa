...
exports.up = async function (knex) {
  ...
  const existingVersion = await knex('workflow_definition_versions')
    .where({ workflow_id: WORKFLOW_ID, version: definition.version })
    .first();
...
exports.down = async function (_knex) {
  // No-op: keep latest workflow definition in place.
};
