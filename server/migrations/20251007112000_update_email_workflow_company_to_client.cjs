// Update the System Email Processing workflow to use client_id instead of company_id

exports.up = async function up(knex) {
  console.log('[workflow-migration:client-id] Updating System Email Processing workflow to use client_id...');
  ...
  if (!registration) {
    console.log('[workflow-migration:client-id] Registration not found; skipping.');
    return;
  }
  ...
  console.log('[workflow-migration:client-id] Updated ' + updated + ' workflow version(s) to use client_id');
};

exports.down = async function down(knex) {
  console.log('[workflow-migration:client-id] Rolling back to company_id...');
  ...
  if (!registration) {
    console.log('[workflow-migration:client-id] Registration not found; skipping rollback.');
    return;
  }
  ...
  console.log('[workflow-migration:client-id] Rolled back ' + updated + ' workflow version(s) to use company_id');
};
