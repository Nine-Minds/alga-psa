...
const TENANT_TABLE_METADATA = {
  ...
  service_request_answer_mapping_versions: { scope: 'tenant' },
  service_request_answer_mappings: { scope: 'tenant' },
  service_request_definitions: { scope: 'tenant' },
  service_request_definition_versions: { scope: 'tenant' },
  service_request_submission_application_results: { scope: 'tenant' },
  service_request_submission_applications: { scope: 'tenant' },
  ...
  tenant_external_systems: { scope: 'tenant' },
