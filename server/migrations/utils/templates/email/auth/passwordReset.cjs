...
const COPY = {
  ...
  es: {
    ...
    headerSubtitle: 'Recuperaci\u00f3n segura de contrase\u00f1a para su cuenta',
    greeting: 'Hola {{userName}},',
    intro: 'Recibimos una solicitud para restablecer la contrase\u00f1a de su cuenta asociada con <strong>{{email}}</strong>.',
    ...
    resetPrompt: 'Para crear una nueva contrase\u00f1a para su cuenta, haga clic en el bot\u00f3n a continuaci\u00f3n:',
    buttonText: 'Restablecer su contrase\u00f1a',
    ...
    warning3: 'Si no solicit\u00f3 este restablecimiento, ignore este correo electr\u00f3nico',
    warning4: 'Su contrase\u00f1a no cambiar\u00e1 hasta que cree una nueva',
    nextTitle: '\u00bfQu\u00e9 Sigue?',
    next1: 'Haga clic en el bot\u00f3n de restablecimiento anterior o use el enlace proporcionado',
    next2: 'Cree una contrase\u00f1a fuerte y \u00fanica para su cuenta',
    next3: 'Iniciar\u00e1 sesi\u00f3n autom\u00e1ticamente despu\u00e9s del restablecimiento',
    next4: 'Todas las sesiones existentes se terminar\u00e1n por seguridad',
    next5: 'Considere habilitar la autenticaci\u00f3n de dos factores para mayor protecci\u00f3n',
    helpTitle: '\u00bfNecesita ayuda?',
    helpText: 'Si tiene problemas para restablecer su contrase\u00f1a, nuestro equipo de soporte est\u00e1 aqu\u00ed para ayudarle.',
    helpContact: '<strong>Contactar Soporte:</strong> {{supportEmail}}',
    footer1: 'Este es un correo electr\u00f3nico de seguridad autom\u00e1tico enviado a {{email}}.',
    footer2: 'Por su seguridad, nunca incluimos contrase\u00f1as en los correos electr\u00f3nicos.',
    ...
    textResetPrompt: 'Para crear una nueva contrase\u00f1a, visite el siguiente enlace:\n{{resetLink}}',
    ...
    textWarning3: '- Si no solicit\u00f3 esto, ignore este correo electr\u00f3nico',
    textWarning4: '- Su contrase\u00f1a no cambiar\u00e1 hasta que cree una nueva',
    textNextHeader: 'QU\u00c9 SIGUE:',
    textNext1: '1. Use el enlace proporcionado arriba',
    textNext2: '2. Cree una contrase\u00f1a fuerte y \u00fanica',
    textNext3: '3. Iniciar\u00e1 sesi\u00f3n autom\u00e1ticamente',
    textNext4: '4. Todas las sesiones existentes se terminar\u00e1n',
    textNext5: '5. Considere habilitar la autenticaci\u00f3n de dos factores',
    textHelp: '\u00bfNecesita ayuda?\nContactar Soporte: {{supportEmail}}',
    textFooter: 'Este es un correo electr\u00f3nico de seguridad autom\u00e1tico enviado a {{email}}.\n\u00a9 {{currentYear}} {{clientName}}. Todos los derechos reservados.',
  },
  de: {
...
COPY.pt = {
  ...
  headerTitle: 'Solicitação de redefinição de senha',
  headerSubtitle: 'Recuperação segura de senha para sua conta',
  greeting: 'Olá {{userName}},',
  intro: 'Recebemos uma solicitação para redefinir a senha da conta associada a <strong>{{email}}</strong>.',
  securityTitle: '🔐 Verificação de segurança da conta',
  securityRequested: '<strong>Solicitado em:</strong> agora',
  securityEmail: '<strong>Email da conta:</strong> {{email}}',
  securityValid: '<strong>Válido por:</strong> {{expirationTime}}',
  resetPrompt: 'Para criar uma nova senha para sua conta, clique no botão abaixo:',
  buttonText: 'Redefinir sua senha',
  linkInstructions: 'Ou copie e cole este link no navegador:',
  warningTitle: '⚠️ Informações importantes de segurança',
  warning1: 'Este link de redefinição de senha expirará em <strong>{{expirationTime}}</strong>',
  warning2: 'Por segurança, este link só pode ser usado <strong>uma vez</strong>',
  warning3: 'Se você não solicitou esta redefinição, ignore este email',
  warning4: 'Sua senha não será alterada até que você crie uma nova',
  nextTitle: 'Próximos passos',
  next1: 'Clique no botão de redefinição acima ou use o link fornecido',
  next2: 'Crie uma senha forte e exclusiva para sua conta',
  next3: 'Você será conectado automaticamente após a redefinição',
  next4: 'Todas as sessões existentes serão encerradas por segurança',
  next5: 'Considere habilitar a autenticação de dois fatores para proteção adicional',
  helpTitle: 'Precisa de ajuda?',
  helpText: 'Se estiver com dificuldades para redefinir sua senha, nossa equipe de suporte está pronta para ajudar.',
  helpContact: '<strong>Contato do suporte:</strong> {{supportEmail}}',
  footer1: 'Este é um email automático de segurança enviado para {{email}}.',
  footer2: 'Para sua segurança, nunca incluímos senhas em emails.',
  footer3: '© {{currentYear}} {{clientName}}. Todos os direitos reservados.',
  textSubject: 'Solicitação de redefinição de senha',
  textSecurityHeader: 'VERIFICAÇÃO DE SEGURANÇA DA CONTA',
  textSecurityRequested: '- Email da conta: {{email}}',
  textSecurityValid: '- Válido por: {{expirationTime}}',
  textResetPrompt: 'REDEFINIR SUA SENHA:\nClique no link abaixo para criar uma nova senha para sua conta:\n{{resetLink}}',
  textWarningHeader: 'INFORMAÇÕES IMPORTANTES DE SEGURANÇA:',
  textWarning1: '- Este link de redefinição de senha expirará em {{expirationTime}}',
  textWarning2: '- Por segurança, este link só pode ser usado uma vez',
  textWarning3: '- Se você não solicitou esta redefinição, ignore este email',
  textWarning4: '- Sua senha não será alterada até que você crie uma nova',
  textNextHeader: 'DEPOIS DE REDEFINIR SUA SENHA:',
  textNext1: '1. Clique no botão de redefinição acima ou use o link fornecido',
  textNext2: '2. Crie uma senha forte e exclusiva para sua conta',
  textNext3: '3. Você será conectado automaticamente após a redefinição',
  textNext4: '4. Todas as sessões existentes serão encerradas por segurança',
  textNext5: '5. Considere habilitar a autenticação de dois fatores para proteção adicional',
  textHelp: 'Precisa de ajuda?\nContato do suporte: {{supportEmail}}',
  textFooter: 'Este é um email automático de segurança enviado para {{email}}.\nPara sua segurança, nunca incluímos senhas em emails.\n© {{currentYear}} {{clientName}}. Todos os direitos reservados.',
};

COPY.sv = {
  subject: 'Begäran om lösenordsåterställning',
  headerTitle: 'Begäran om lösenordsåterställning',
  headerSubtitle: 'Säker lösenordsåterställning för ditt konto',
  greeting: 'Hej {{userName}},',
  intro: 'Vi har fått en begäran om att återställa lösenordet för kontot som är kopplat till <strong>{{email}}</strong>.',
  securityTitle: '🔐 Säkerhetskontroll av kontot',
  securityRequested: '<strong>Begärt:</strong> nyss',
  securityEmail: '<strong>Kontots e-postadress:</strong> {{email}}',
  securityValid: '<strong>Giltig i:</strong> {{expirationTime}}',
  resetPrompt: 'Klicka på knappen nedan för att skapa ett nytt lösenord för ditt konto:',
  buttonText: 'Återställ ditt lösenord',
  linkInstructions: 'Eller kopiera och klistra in den här länken i din webbläsare:',
  warningTitle: '⚠️ Viktig säkerhetsinformation',
  warning1: 'Den här länken för lösenordsåterställning slutar gälla om <strong>{{expirationTime}}</strong>',
  warning2: 'Av säkerhetsskäl kan den här länken bara användas <strong>en gång</strong>',
  warning3: 'Om du inte har begärt den här återställningen kan du ignorera det här e-postmeddelandet',
  warning4: 'Ditt lösenord ändras inte förrän du skapar ett nytt',
  nextTitle: 'Nästa steg',
  next1: 'Klicka på återställningsknappen ovan eller använd länken',
  next2: 'Skapa ett starkt och unikt lösenord för ditt konto',
  next3: 'Du loggas in automatiskt efter återställningen',
  next4: 'Alla befintliga sessioner avslutas av säkerhetsskäl',
  next5: 'Överväg att aktivera tvåfaktorsautentisering för extra skydd',
  helpTitle: 'Behöver du hjälp?',
  helpText: 'Om du har problem med att återställa ditt lösenord hjälper vårt supportteam dig gärna.',
  helpContact: '<strong>Kontakta supporten:</strong> {{supportEmail}}',
  footer1: 'Det här är ett automatiskt säkerhetsmeddelande som har skickats till {{email}}.',
  footer2: 'För din säkerhet skickar vi aldrig lösenord via e-post.',
  footer3: '© {{currentYear}} {{clientName}}. Alla rättigheter förbehållna.',
  textSubject: 'Begäran om lösenordsåterställning',
  textSecurityHeader: 'Säkerhetskontroll av kontot',
  textSecurityRequested: '- Kontots e-postadress: {{email}}',
  textSecurityValid: '- Giltig i: {{expirationTime}}',
  textResetPrompt: 'Återställ ditt lösenord:\nKlicka på länken nedan för att skapa ett nytt lösenord för ditt konto:\n{{resetLink}}',
  textWarningHeader: 'Viktig säkerhetsinformation:',
  textWarning1: '- Den här länken för lösenordsåterställning slutar gälla om {{expirationTime}}',
  ...
  textNext4: '4. Alla befintliga sessioner avslutas av säkerhetsskäl',
  textNext5: '5. Överväg att aktivera tvåfaktorsautentisering för extra skydd',
  textHelp: 'Behöver du hjälp?\nKontakta supporten: {{supportEmail}}',
  textFooter: 'Det här är ett automatiskt säkerhetsmeddelande som har skickats till {{email}}.\nFör din säkerhet skickar vi aldrig lösenord via e-post.\n© {{currentYear}} {{clientName}}. Alla rättigheter förbehållna.',
};
