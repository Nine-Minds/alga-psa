...
const COPY = {
  ...
  es: {
    subject: 'Se le invita a unirse a {{tenantName}} en AlgaPSA',
    title: 'Invitación al equipo',
    headerTitle: 'Le damos la bienvenida al equipo',
    headerSubtitle: 'Se le invita a unirse a {{tenantName}}',
    greeting: 'Hola {{teamMemberName}},',
    intro: '{{invitedByName}} le ha invitado a unirse a <strong>{{tenantName}}</strong> como <strong>{{roleName}}</strong>. Configure su cuenta para comenzar.',
    infoBoxTitle: 'Qué sigue',
    feature1: '✓ Haga clic en el botón de abajo para establecer su propia contraseña',
    feature2: '✓ Inicie sesión con su correo electrónico de trabajo y la nueva contraseña',
    feature3: '✓ Comience a gestionar tickets, clientes y proyectos de inmediato',
    buttonLabel: 'Configurar su cuenta',
    copyLinkHint: 'O copie y pegue este enlace en su navegador:',
    warningTitle: '⏰ Invitación con tiempo limitado',
    warningText: 'Este enlace de invitación expirará en <strong>{{expirationTime}}</strong>. Complete la configuración de su cuenta antes de esa fecha.',
    footerSent: 'Este correo electrónico fue enviado a {{teamMemberName}} como parte de la configuración de su cuenta de {{tenantName}}.',
    footerUnexpected: 'Si no esperaba esta invitación, puede ignorar este correo electrónico con seguridad.',
