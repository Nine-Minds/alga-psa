...
const COPY = {
  ...
  pt: {
    ...
    alert: 'Um ticket violou sua meta de SLA e exige atenção imediata.',
    ticket: 'Ticket',
    slaType: 'Tipo de SLA',
    ...
    client: 'Cliente',
    policy: 'Política de SLA',
    callToAction: 'Trate este ticket imediatamente.',
    viewButton: 'Ver ticket agora',
    ...
    textAlert: 'Um ticket violou sua meta de SLA e exige atenção imediata.',
