...
const SUBJECTS = {
  ...
  pt: 'VIOLAÇÃO DE SLA: chamado #{{ticketNumber}} - SLA {{slaType}} excedido',
};
...
const COPY = {
  ...
  pt: {
    headerLabel: 'Violação de SLA',
    headerTitle: 'SLA {{slaType}} excedido',
    headerMeta: 'Chamado #{{ticketNumber}}',
    greeting: 'Olá {{recipientName}},',
    alert: 'Um chamado violou sua meta de SLA e exige atenção imediata.',
    ticket: 'Chamado',
    slaType: 'Tipo de SLA',
    timeOverdue: 'Tempo em atraso',
    priority: 'Prioridade',
    client: 'Cliente',
    policy: 'Política de SLA',
    callToAction: 'Trate este chamado imediatamente.',
    viewButton: 'Ver chamado agora',
    footer: 'Powered by Alga PSA &middot; Mantendo as equipes alinhadas',
    textHeader: 'VIOLAÇÃO DE SLA: SLA {{slaType}} excedido',
    textGreeting: 'Olá {{recipientName}},',
    textAlert: 'Um chamado violou sua meta de SLA e exige atenção imediata.',
    textDetailsHeader: 'Detalhes do chamado:',
    textTicket: 'Chamado',
    textSlaType: 'Tipo de SLA',
    textTimeOverdue: 'Tempo em atraso',
    textPriority: 'Prioridade',
    textClient: 'Cliente',
    textPolicy: 'Política de SLA',
    textCallToAction: 'Trate este chamado imediatamente.',
