...
const SUBJECTS = {
  ...
  pt: 'Chamado escalonado: #{{ticketNumber}} - nível {{escalationLevel}}',
};
...
const COPY = {
  ...
  pt: {
    headerLabel: 'Escalonamento de chamado',
    headerTitle: 'Escalonamento de nível {{escalationLevel}}',
    headerMeta: 'Chamado #{{ticketNumber}}',
    greeting: 'Olá {{recipientName}},',
    intro: 'Um chamado foi escalonado para você por questões de SLA. Você foi adicionado como gerente de escalonamento.',
    ticket: 'Chamado',
    ...
    callToAction: 'Revise este chamado e tome a ação apropriada.',
    viewButton: 'Ver chamado',
    footer: 'Powered by Alga PSA &middot; Mantendo as equipes alinhadas',
    textHeader: 'ESCALONAMENTO DE CHAMADO: nível {{escalationLevel}}',
    textGreeting: 'Olá {{recipientName}},',
    textIntro: 'Um chamado foi escalonado para você por questões de SLA. Você foi adicionado como gerente de escalonamento.',
    textDetailsHeader: 'Detalhes do chamado:',
    textTicket: 'Chamado',
    ...
    textCallToAction: 'Revise este chamado e tome a ação apropriada.',
