...
const COPY = {
  ...
  pt: {
    headerLabel: 'Escalonamento de ticket',
    headerTitle: 'Escalonamento de nível {{escalationLevel}}',
    headerMeta: 'Ticket #{{ticketNumber}}',
    greeting: 'Olá {{recipientName}},',
    intro: 'Um ticket foi escalonado para você por questões de SLA. Você foi adicionado como gerente de escalonamento.',
    ticket: 'Ticket',
    ...
    callToAction: 'Revise este ticket e tome a ação apropriada.',
    viewButton: 'Ver ticket',
    footer: 'Powered by AlgaPSA &middot; Mantendo as equipes alinhadas',
    textHeader: 'ESCALONAMENTO DE TICKET: nível {{escalationLevel}}',
    textGreeting: 'Olá {{recipientName}},',
    textIntro: 'Um ticket foi escalonado para você por questões de SLA. Você foi adicionado como gerente de escalonamento.',
    textDetailsHeader: 'Detalhes do ticket:',
    textTicket: 'Ticket',
    textEscalationLevel: 'Nível de escalonamento',
    textLevelPrefix: 'Nível',
    textReason: 'Motivo',
    textPriority: 'Prioridade',
    textClient: 'Cliente',
    textAssignedTo: 'Atribuído a',
    textCallToAction: 'Revise este ticket e tome a ação apropriada.',
    textView: 'Ver ticket',
    textFooter: 'Powered by AlgaPSA',
  },
  sv: {
    headerLabel: 'Ärendeeskalering',
    headerTitle: 'Eskalering till nivå {{escalationLevel}}',
    headerMeta: 'Ärende #{{ticketNumber}}',
    greeting: 'Hej {{recipientName}},',
    intro: 'Ett ärende har eskalerats till dig på grund av SLA-relaterade problem. Du har lagts till som eskaleringsansvarig.',
    ticket: 'Ärende',
    escalationLevel: 'Eskaleringsnivå',
    levelPrefix: 'Nivå',
    reason: 'Orsak',
    priority: 'Prioritet',
    client: 'Kund',
    ...
    textTicket: 'Ärende',
    textEscalationLevel: 'Eskaleringsnivå',
    textLevelPrefix: 'Nivå',
    textReason: 'Orsak',
    textPriority: 'Prioritet',
    textClient: 'Kund',
    textAssignedTo: 'Tilldelat till',
    textCallToAction: 'Granska detta ärende och vidta lämpliga åtgärder.',
