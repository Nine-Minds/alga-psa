...
const COPY = {
  ...
  pt: {
    ...
    intro: 'Um ticket sob sua responsabilidade está se aproximando do prazo de SLA.',
    ticket: 'Ticket',
    slaType: 'Tipo de SLA',
    ...
    textIntro: 'Um ticket sob sua responsabilidade está se aproximando do prazo de SLA.',
