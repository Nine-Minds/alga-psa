...
const SUBJECTS = {
  ...
  pt: 'Aviso de SLA: chamado #{{ticketNumber}} em {{thresholdPercent}}%',
};
...
const COPY = {
  ...
  pt: {
    headerLabel: 'Aviso de SLA',
    headerTitle: '{{thresholdPercent}}% do tempo decorrido',
    headerMeta: 'Chamado #{{ticketNumber}}',
    greeting: 'Olá {{recipientName}},',
    intro: 'Um chamado sob sua responsabilidade está se aproximando do prazo de SLA.',
    ticket: 'Chamado',
    slaType: 'Tipo de SLA',
    timeRemaining: 'Tempo restante',
    priority: 'Prioridade',
    client: 'Cliente',
    callToAction: 'Tome uma ação para evitar uma violação de SLA.',
    viewButton: 'Ver chamado',
    footer: 'Powered by Alga PSA &middot; Mantendo as equipes alinhadas',
    textHeader: 'AVISO DE SLA: {{thresholdPercent}}% do tempo decorrido',
    textGreeting: 'Olá {{recipientName}},',
    textIntro: 'Um chamado sob sua responsabilidade está se aproximando do prazo de SLA.',
    textDetailsHeader: 'Detalhes do chamado:',
    textTicket: 'Chamado',
    textSlaType: 'Tipo de SLA',
    textTimeRemaining: 'Tempo restante',
