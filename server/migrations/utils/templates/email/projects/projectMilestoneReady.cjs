...
const COPY = {
  ...
  it: { subject: 'Pronto per la fatturazione: {{entry.description}}', label: 'Traguardo pronto', intro: 'Una voce del piano di fatturazione del progetto è pronta.', entry: 'Voce del piano', amount: 'Importo', trigger: 'Attivazione', button: 'Rivedi progetto', footer: 'Powered by Alga PSA' },
