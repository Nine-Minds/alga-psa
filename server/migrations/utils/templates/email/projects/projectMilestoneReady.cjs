...
const COPY = {
  en: { subject: 'Ready to bill: {{entry.description}}', label: 'Milestone Ready', intro: 'A project schedule entry is ready for billing.', entry: 'Schedule entry', amount: 'Amount', trigger: 'Trigger', button: 'Review project', footer: 'Powered by AlgaPSA' },
  fr: { subject: 'Prêt à facturer : {{entry.description}}', label: 'Jalon prêt', intro: 'Une entrée du calendrier du projet est prête à être facturée.', entry: 'Entrée du calendrier', amount: 'Montant', trigger: 'Déclencheur', button: 'Examiner le projet', footer: 'Propulsé par AlgaPSA' },
  es: { subject: 'Listo para facturar: {{entry.description}}', label: 'Hito listo', intro: 'Una entrada del calendario del proyecto está lista para facturarse.', entry: 'Entrada del calendario', amount: 'Importe', trigger: 'Desencadenador', button: 'Revisar proyecto', footer: 'Desarrollado por AlgaPSA' },
  de: { subject: 'Bereit zur Abrechnung: {{entry.description}}', label: 'Meilenstein bereit', intro: 'Ein Eintrag im Projektzahlungsplan ist zur Abrechnung bereit.', entry: 'Planeintrag', amount: 'Betrag', trigger: 'Auslöser', button: 'Projekt prüfen', footer: 'Bereitgestellt von AlgaPSA' },
  nl: { subject: 'Klaar om te factureren: {{entry.description}}', label: 'Mijlpaal klaar', intro: 'Een item in het projectfacturatieschema is klaar voor facturering.', entry: 'Schema-item', amount: 'Bedrag', trigger: 'Trigger', button: 'Project bekijken', footer: 'Mogelijk gemaakt door AlgaPSA' },
