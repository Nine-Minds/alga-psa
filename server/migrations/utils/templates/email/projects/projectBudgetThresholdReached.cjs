...
const COPY = {
  en: { subject: 'Project budget threshold reached: {{project.name}}', label: 'Budget Threshold Reached', intro: 'This project has crossed a configured budget notification threshold.', threshold: 'Threshold', billed: 'Billed', cap: 'Budget cap', button: 'Review project', footer: 'Powered by AlgaPSA' },
  fr: { subject: 'Seuil budgétaire atteint : {{project.name}}', label: 'Seuil budgétaire atteint', intro: 'Ce projet a franchi un seuil de notification budgétaire configuré.', threshold: 'Seuil', billed: 'Facturé', cap: 'Plafond budgétaire', button: 'Examiner le projet', footer: 'Propulsé par AlgaPSA' },
  es: { subject: 'Umbral de presupuesto alcanzado: {{project.name}}', label: 'Umbral de presupuesto alcanzado', intro: 'Este proyecto ha superado un umbral de notificación de presupuesto configurado.', threshold: 'Umbral', billed: 'Facturado', cap: 'Tope de presupuesto', button: 'Revisar proyecto', footer: 'Desarrollado por AlgaPSA' },
  de: { subject: 'Projektbudget-Schwellenwert erreicht: {{project.name}}', label: 'Budget-Schwellenwert erreicht', intro: 'Dieses Projekt hat einen konfigurierten Budget-Schwellenwert überschritten.', threshold: 'Schwellenwert', billed: 'Abgerechnet', cap: 'Budgetobergrenze', button: 'Projekt prüfen', footer: 'Bereitgestellt von AlgaPSA' },
  nl: { subject: 'Projectbudgetdrempel bereikt: {{project.name}}', label: 'Budgetdrempel bereikt', intro: 'Dit project heeft een ingestelde budgetmeldingsdrempel overschreden.', threshold: 'Drempel', billed: 'Gefactureerd', cap: 'Budgetlimiet', button: 'Project bekijken', footer: 'Mogelijk gemaakt door AlgaPSA' },
