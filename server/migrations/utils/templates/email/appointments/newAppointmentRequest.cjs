...
const COPY = {
  ...
  fr: {
    ...
    footer: 'Powered by AlgaPSA &middot; Maintenir les \u00e9quipes align\u00e9es',
...
SUBJECTS.pt = 'Nova solicitação de agendamento - {{clientName}}{{#if serviceName}} - {{serviceName}}{{/if}}';
SUBJECTS.sv = 'Ny bokningsförfrågan - {{clientName}}{{#if serviceName}} - {{serviceName}}{{/if}}';
COPY.pt = {
  headerLabel: 'Nova solicitação de agendamento',
  headerSub: 'Ação necessária',
  greeting: 'Equipe,',
  intro: 'Uma nova solicitação de agendamento foi enviada e requer sua análise e aprovação.',
  requesterTitle: 'Informações do solicitante',
  requesterEmail: 'Email:',
  requesterPhone: 'Telefone:',
  company: 'Empresa:',
  client: 'Cliente:',
  requestTitle: 'Detalhes da solicitação',
  ...
  durationUnit: 'minutos',
  preferredTechnician: 'Técnico preferido:',
  notesTitle: 'Observações adicionais',
  reviewButton: 'Revisar e aprovar',
  reviewMsg: 'Revise esta solicitação e tome a ação adequada. O solicitante está aguardando a confirmação.',
  referenceMsg: 'Referência da solicitação: {{referenceNumber}}',
  footer: 'Powered by AlgaPSA &middot; Mantendo as equipes alinhadas',
  textHeader: 'Nova solicitação de agendamento - Ação necessária',
  textRequesterHeader: 'INFORMAÇÕES DO SOLICITANTE',
  textName: 'Nome',
  textEmail: 'Email',
  textPhone: 'Telefone',
  textCompany: 'Empresa',
  textClient: 'Cliente',
  textRequestHeader: 'DETALHES DA SOLICITAÇÃO',
  textReference: 'Referência',
  textSubmitted: 'Enviada',
  textTicket: 'Ticket',
  textType: 'Tipo',
  textTypeAuth: 'Solicitação do portal do cliente',
  textTypePublic: 'Solicitação pública',
  ...
  textDurationUnit: 'minutos',
  textPreferredTechnician: 'Técnico preferido',
  textNotesHeader: 'OBSERVAÇÕES ADICIONAIS',
  textReviewHeader: 'REVISAR E APROVAR',
};

COPY.sv = {
  headerLabel: 'Ny bokningsförfrågan',
  headerSub: 'Åtgärd krävs',
  greeting: 'Hej teamet,',
  intro: 'En ny bokningsförfrågan har skickats in och behöver granskas och godkännas av er.',
  requesterTitle: 'Uppgifter om förfrågans avsändare',
  requesterEmail: 'E-post:',
  requesterPhone: 'Telefon:',
  company: 'Företag:',
  client: 'Kund:',
  requestTitle: 'Förfrågans detaljer',
  referenceLabel: 'Referens:',
  submittedLabel: 'Inskickad:',
  ticketLabel: 'Ärende:',
  ...
  notesTitle: 'Ytterligare anteckningar',
  reviewButton: 'Granska och godkänn',
  reviewMsg: 'Granska den här förfrågan och vidta lämplig åtgärd. Avsändaren väntar på bekräftelse.',
  referenceMsg: 'Förfrågans referens: {{referenceNumber}}',
  footer: 'Drivs av AlgaPSA &middot; Håller team samordnade',
  textHeader: 'Ny bokningsförfrågan - Åtgärd krävs',
  textRequesterHeader: 'Uppgifter om förfrågans avsändare',
  textName: 'Namn',
  textEmail: 'E-post',
  textPhone: 'Telefon',
  textCompany: 'Företag',
  textClient: 'Kund',
  textRequestHeader: 'Förfrågans detaljer',
  textReference: 'Referens',
  textSubmitted: 'Inskickad',
  textTicket: 'Ärende',
  textType: 'Typ',
  textTypeAuth: 'Förfrågan från kundportalen',
  textTypePublic: 'Offentlig förfrågan',
  ...
  textNotesHeader: 'Ytterligare anteckningar',
  textReviewHeader: 'Granska och godkänn',
};
