...
const SUBJECTS = {
  ...
  it: 'Inserimento ore inviato per l\u2019approvazione',
...
const COPY = {
  ...
  it: {
    headerLabel: 'Inserimento ore inviato',
    intro: '\u00c8 stato inviato un inserimento ore per l\u2019approvazione.',
    submittedBy: 'Inviato da',
    date: 'Data',
    duration: 'Durata',
    project: 'Progetto',
    task: 'Attivit\u00e0',
    viewButton: 'Esamina inserimento ore',
    footer: 'Powered by AlgaPSA &middot; Manteniamo i team allineati',
    textHeader: 'Inserimento ore inviato',
    textIntro: '\u00c8 stato inviato un inserimento ore per l\u2019approvazione:',
    textView: 'Esamina l\u2019inserimento ore su',
  },
  pl: {
