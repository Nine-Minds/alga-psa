...
const COPY = {
  ...
  it: {
    headerLabel: 'Inserimento ore respinto',
    intro: 'Il tuo inserimento ore \u00e8 stato respinto.',
    date: 'Data',
    duration: 'Durata',
    project: 'Progetto',
    task: 'Attivit\u00e0',
    rejectedBy: 'Respinto da',
    reason: 'Motivo',
    viewButton: 'Visualizza inserimento ore',
    footer: 'Powered by Alga PSA &middot; Manteniamo i team allineati',
    textHeader: 'Inserimento ore respinto',
    textIntro: 'Il tuo inserimento ore \u00e8 stato respinto:',
