...
const COPY = {
  ...
  it: {
    headerLabel: 'Inserimento ore approvato',
    intro: 'Il tuo inserimento ore \u00e8 stato approvato.',
    date: 'Data',
    duration: 'Durata',
    project: 'Progetto',
    task: 'Attivit\u00e0',
    approvedBy: 'Approvato da',
    viewButton: 'Visualizza inserimento ore',
    footer: 'Powered by AlgaPSA &middot; Manteniamo i team allineati',
    textHeader: 'Inserimento ore approvato',
    textIntro: 'Il tuo inserimento ore \u00e8 stato approvato:',
    textView: 'Visualizza l\u2019inserimento ore su',
  },
  pl: {
...
COPY.sv = {
  headerLabel: 'Tidpost godkänd',
  intro: 'Din tidpost har godkänts.',
  date: 'Datum',
