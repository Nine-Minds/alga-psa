...
const TEMPLATES = [
  // ── ticket-assigned ──────────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Chamado atribuído', message: 'O chamado #{{ticketId}} "{{ticketTitle}}" ({{priority}}) foi atribuído a você por {{performedByName}}' },
    },
  },
  ...
  // ── ticket-created ───────────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Novo chamado criado', message: 'O chamado #{{ticketId}} "{{ticketTitle}}" foi criado para {{clientName}}' },
    },
  },
  ...
  // ── ticket-created-client ────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Seu chamado de suporte foi criado', message: 'Seu chamado #{{ticketId}} "{{ticketTitle}}" foi criado e nossa equipe responderá em breve' },
    },
  },
  ...
  // ── ticket-updated ───────────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Chamado atualizado', message: 'O chamado #{{ticketId}} "{{ticketTitle}}" foi atualizado' },
    },
  },
  ...
  // ── ticket-updated-client ────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Seu chamado foi atualizado', message: 'Seu chamado #{{ticketId}} "{{ticketTitle}}" foi atualizado' },
    },
  },
  ...
  // ── ticket-closed ────────────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Chamado fechado', message: 'O chamado #{{ticketId}} "{{ticketTitle}}" foi fechado' },
    },
  },
  ...
  // ── ticket-closed-client ─────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Seu chamado foi fechado', message: 'Seu chamado #{{ticketId}} "{{ticketTitle}}" foi fechado' },
    },
  },
  ...
  // ── ticket-comment-added ─────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Novo comentário', message: '{{authorName}} comentou no chamado #{{ticketId}}: "{{commentPreview}}"' },
    },
  },
  ...
  // ── ticket-comment-added-client ──────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Novo comentário no seu chamado', message: '{{authorName}} comentou em seu chamado #{{ticketId}}: "{{commentPreview}}"' },
    },
  },
  ...
  // ── ticket-status-changed ────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Status do chamado alterado', message: 'Status do chamado #{{ticketId}} "{{ticketTitle}}" alterado: {{oldStatus}} → {{newStatus}} por {{performedByName}}' },
    },
  },
  ...
  // ── ticket-priority-changed ──────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Prioridade do chamado alterada', message: 'Prioridade do chamado #{{ticketId}} "{{ticketTitle}}" alterada: {{oldPriority}} → {{newPriority}} por {{performedByName}}' },
    },
  },
  ...
  // ── ticket-reassigned ────────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Chamado reatribuído', message: 'Chamado #{{ticketId}} "{{ticketTitle}}" reatribuído: {{oldAssignedTo}} → {{newAssignedTo}} por {{performedByName}}' },
    },
  },
  ...
  // ── ticket-additional-agent-assigned ─────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Adicionado como agente adicional', message: 'Você foi adicionado como agente adicional no chamado #{{ticketId}} "{{ticketTitle}}" ({{priority}})' },
    },
  },
  ...
  // ── ticket-additional-agent-added ────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Agente Adicional Adicionado', message: '{{additionalAgentName}} foi adicionado como agente adicional ao seu chamado #{{ticketId}} "{{ticketTitle}}"' },
    },
  },
  ...
  // ── ticket-team-assigned ────────────────────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Equipe atribuída ao chamado', message: 'A equipe \'{{teamName}}\' foi designada para o chamado #{{ticketId}} \'{{ticketTitle}}\' por {{performedByName}}' },
    },
  },
  ...
  // ── ticket-additional-agent-added-client ─────────────────────────────
  {
    ...
    translations: {
      ...
      pt: { title: 'Agente de suporte adicional atribuído', message: '{{additionalAgentName}} foi adicionado para ajudar com seu chamado #{{ticketId}} "{{ticketTitle}}"' },
    },
  },
  ...
  // assigned to an existing ticket (first assignment, post-creation).
  {
    ...
    translations: {
      ...
      pt: { title: 'Seu chamado está sendo trabalhado', message: '{{assignedToName}} foi atribuído ao seu chamado #{{ticketId}} "{{ticketTitle}}"' },
    },
  },
];
