...
const ContactAvatar: React.FC<ContactAvatarProps> = ({
  ...
  // Use contactName for color generation for consistency if ID changes or isn't stable
  const fallbackColors = generateEntityColor(contactName || String(contactId));
