...
import { BillingSettings, TaxDelegationNudge, QboSyncHealthPanel } from '@alga-psa/billing/components';
  ...
  const baseTabContent: SettingsTabContent[] = [
    ...
    },
    {
      ...
      content: (
        <>
          <TaxDelegationNudge />
          <IntegrationsSettingsPage canUseEntraSync={canUseEntraSync} canUseCipp={canUseCipp} canUseTeams={canUseTeams} qboSyncHealthSlot={<QboSyncHealthPanel />} />
        </>
      ),
    }
  ];
