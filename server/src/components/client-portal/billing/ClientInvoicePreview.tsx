...
import PaperInvoice from 'server/src/components/billing-dashboard/PaperInvoice';
...
import type { IInvoiceTemplate } from 'server/src/interfaces/invoice.interfaces';
