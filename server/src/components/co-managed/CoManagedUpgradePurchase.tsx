...
import { purchaseCoManagedUpgradeAction } from '@ee/lib/actions/coManagedUpgradeActions';
...
export default function CoManagedUpgradePurchase({ seatsRequired, pendingPurchase, onChanged }: {
  seatsRequired: number; pendingPurchase?: CoManagedUpgradePurchaseRequest | null; onChanged: () => Promise<void>;
}) {
  ...
  return <div className="space-y-4">
    ...
    <div className="flex flex-wrap items-end gap-3">
      ...
      <Button id="co-upgrade-purchase" disabled={busy || (!command.current && (!Number.isSafeInteger(quantity) || quantity < seatsRequired || quantity > 100000))}
