...
const STEP_DEFINITIONS: Record<OnboardingStepId, StepDefinition> = {
  identity_sso: {
    ...
    icon: ShieldCheck,
    ctaHref: '/msp/account/sso',
    ctaLabel: 'Connect SSO',
    analyticsTarget: 'identity_sso',
  },
  client_portal_domain: {
    id: 'client_portal_domain',
    title: 'Client Portal Domain',
    description: 'Verify a custom portal domain so clients see your brand on every login.',
    icon: Globe,
  ...
  managed_email: {
    id: 'managed_email',
    title: 'Managed Email Domain',
    description: 'Verify a sending domain so outbound status updates land in inboxes instead of spam.',
    icon: MailCheck,
    ctaHref: '/msp/settings?tab=email',
    ctaLabel: 'Manage Email',
