...
interface ClientBundleDialogProps {
...
export function ClientBundleDialog({ 
  onBundleAssigned, 
  onClose, 
  triggerButton, 
  isOpen = false,
  ...
  return (
    <>
      ...
      <Dialog
        isOpen={open}
        onClose={handleClose}
        title={initialStartDate ? 'Edit Bundle Assignment' : 'Assign Bundle to Client'}
        className="max-w-md"
      >
        <DialogContent>
