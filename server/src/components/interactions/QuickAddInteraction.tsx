...
import { addInteraction, updateInteraction, getInteractionById, getInteractionStatuses } from '@product/actions/interactionActions';
import { getAllInteractionTypes } from '@product/actions/interactionTypeActions';
...
import { getAllContacts } from '@product/actions/contact-actions/contactActions';
