...
const TicketProperties: React.FC<TicketPropertiesProps> = ({
  ...
  return (
    <div className="flex-shrink-0 space-y-6">
      <ReflectionContainer id={`${id}-time-entry`} label="Time Entry">
      ...
      <ReflectionContainer id={`${id}-contact-info`} label="Contact Information">
        <div className={`${styles['card']} p-6 space-y-4`}>
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <p {...useAutomationIdAndRegister<ContainerComponent>({
                ...
                type: 'container',
                label: 'Created By'
              }).automationIdProps} className="text-sm">
      ...
      <ReflectionContainer id={`${id}-agent-team`} label="Agent Team">
        <div className={`${styles['card']} p-6 space-y-4`}>
            ...
            <div>
              ...
              {ticket.assigned_to ? (
                ...
                >
                  <AvatarIcon
                    {...useAutomationIdAndRegister<ContainerComponent>({
                      id: `${id}-primary-agent-avatar`,
                      type: 'container',
                      label: 'Primary Agent Avatar'
                    }).automationIdProps}
                ...
                {additionalAgents.map((agent) => {
                  ...
                  return (
                    <div 
                      ...
                      {...useAutomationIdAndRegister<ContainerComponent>({
                        id: `${id}-additional-agent-${agent.additional_user_id}`,
                        type: 'container',
                        label: `Additional Agent ${agentUser?.first_name || 'Unknown'} ${agentUser?.last_name || 'Agent'}`
                      }).automationIdProps}
                    ...
                    >
                      ...
                      >
                        <AvatarIcon
                          {...useAutomationIdAndRegister<ContainerComponent>({
                            id: `${id}-agent-${agent.additional_user_id}-avatar`,
                            type: 'container',
                            label: `Agent ${agentUser?.first_name || 'Unknown'} Avatar`
                          }).automationIdProps}
                      ...
                      <Button
                        {...useAutomationIdAndRegister<ButtonComponent>({
                          id: `${id}-remove-agent-${agent.assignment_id}-btn`,
                          type: 'button',
                          label: 'Remove Agent',
                          actions: ['click']
                        }).automationIdProps}
