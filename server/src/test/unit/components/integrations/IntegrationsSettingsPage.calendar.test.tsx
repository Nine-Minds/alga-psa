...
vi.mock('@enterprise/components/settings/integrations/CalendarIntegrationsSettings', () => ({
  __esModule: true,
  default: () => <div data-testid="calendar-enterprise-settings-shell">Calendar Enterprise Settings</div>,
}));
