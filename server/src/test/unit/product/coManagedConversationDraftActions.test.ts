...
const mocks = vi.hoisted(() => ({ begin: vi.fn(), upload: vi.fn(), publish: vi.fn(), object: vi.fn(), customer: vi.fn(), session: vi.fn(), override: vi.fn(), db: vi.fn(),
...
vi.mock('@alga-psa/co-managed', () => ({ beginCoManagedConversationDraft: mocks.begin, uploadCoManagedDraftAttachment: mocks.upload, publishCoManagedConversationDraft: mocks.publish,
