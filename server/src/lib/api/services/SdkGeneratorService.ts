...
export class AlgaPSAClient {
  ...
  private static generateTeamsResource(): string {
    return `import { HttpClient } from '../utils/http';
import { HateoasResponse, PaginatedResponse } from '../types/hateoas';
import { Team, CreateTeamRequest, UpdateTeamRequest, TeamFilters } from '../types';
...
export class ProjectsResource {
  ...
  private static generateTicketsResource(): string {
    return `import { HttpClient } from '../utils/http';
import { HateoasResponse, PaginatedResponse } from '../types/hateoas';
import { Ticket, CreateTicketRequest, UpdateTicketRequest, TicketFilters } from '../types';
...
export class UsersResource {
  ...
  private static generateWebhooksResource(): string {
    return `import { HttpClient } from '../utils/http';
import { HateoasResponse, PaginatedResponse } from '../types/hateoas';
import { Webhook, CreateWebhookRequest, UpdateWebhookRequest, WebhookFilters } from '../types';
...
export class HttpClient {
  ...
  private static generateHateoasUtils(): string {
    return `import { HateoasLink, HateoasResponse } from '../types/hateoas';
