  ...
  startTracking() {
    return async (req: NextRequest): Promise<NextResponse> => {
      try {
        ...
        let trackingData;
        try {
          trackingData = startTrackingSchema.parse(body);
        } catch (error) {
          if (error instanceof ZodError) {
  ...
  stopTracking() {
    return async (req: NextRequest): Promise<NextResponse> => {
      try {
        ...
        let stopData;
        try {
          stopData = stopTrackingSchema.parse(body);
        } catch (error) {
          if (error instanceof ZodError) {
  ...
  requestChanges() {
    return async (req: NextRequest): Promise<NextResponse> => {
      try {
        ...
        let changeData;
        try {
          changeData = requestChangesSchema.parse(body);
        } catch (error) {
          if (error instanceof ZodError) {
  ...
  bulkCreate() {
    return async (req: NextRequest): Promise<NextResponse> => {
      try {
        ...
        let bulkData;
        try {
          bulkData = bulkCreateTimeEntriesSchema.parse(body);
        } catch (error) {
          if (error instanceof ZodError) {
