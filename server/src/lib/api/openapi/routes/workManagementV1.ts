...
export function registerWorkManagementV1Routes(registry: ApiOpenApiRegistry) {
  ...
  const defs: Def[] = [
    ...
    { method: 'get', path: '/api/v1/tickets/{id}/assets', summary: 'List ticket assets', description: 'Lists assets linked to ticket UUID via asset_associations, the same table the UI and ticket-from-asset flow use.', family: 'ticket' },
