...
import { registerMarketingV1Routes } from './routes/marketingV1';
import { registerInteractionsV1Routes } from './routes/interactionsV1';
import { registerInventoryV1Routes } from './routes/inventoryV1';
import { registerMobileCapabilitiesV1Routes } from './routes/mobileCapabilitiesV1';
...
export function buildBaseRegistry(options: RegistryInitOptions = {}): ApiOpenApiRegistry {
  ...
  registerInteractionsV1Routes(registry);
  registerInventoryV1Routes(registry);
  registerMobileCapabilitiesV1Routes(registry);
