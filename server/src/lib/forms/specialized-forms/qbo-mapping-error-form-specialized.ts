...
export const qboMappingErrorFormSpecialized: FormDefinition = {
  name: 'QBO Mapping Error Form Specialized',
  description: 'Form for handling generic QBO mapping errors.',
  jsonSchema: {
    type: 'object',
    properties: {
