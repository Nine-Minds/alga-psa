/**
 * QuickBooks Bulk Sync API Route
 * POST /api/v1/integrations/quickbooks/sync/bulk - Execute bulk synchronization
 */
...
export async function POST(request: Request) {
  try {
    return await getController().bulkSync()(request as any);
  } catch (error) {
