/**
 * QuickBooks Customer Mappings API Route
 * GET /api/v1/integrations/quickbooks/customers/mappings - Get customer mappings
 */
...
export async function GET(request: Request) {
  try {
    return await getController().getCustomerMappings()(request as any);
  } catch (error) {
