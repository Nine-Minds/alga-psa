/**
 * QuickBooks Customer Sync API Route
 * POST /api/v1/integrations/quickbooks/customers/sync - Synchronize customers
 */
...
export async function POST(request: Request) {
  try {
    return await getController().syncCustomers()(request as any);
  } catch (error) {
