/**
 * QuickBooks Connection Status API Route
 * GET /api/v1/integrations/quickbooks/connection/status - Get connection status
 */
...
export async function GET(request: Request) {
  try {
    return await getController().getConnectionStatus()(request as any);
  } catch (error) {
