/**
 * QuickBooks Connection Refresh API Route
 * POST /api/v1/integrations/quickbooks/connection/refresh - Refresh OAuth tokens
 */
...
export async function POST(request: Request) {
  try {
    return await getController().refreshConnection()(request as any);
  } catch (error) {
