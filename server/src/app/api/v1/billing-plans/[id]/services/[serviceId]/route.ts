...
export async function PUT(
  ...
  return controller.updatePlanService()(request, { params: Promise.resolve({ planId: resolvedParams.id, serviceId: resolvedParams.serviceId }) });
}
...
export async function DELETE(
  ...
  return controller.removeServiceFromPlan()(request, { params: Promise.resolve({ planId: resolvedParams.id, serviceId: resolvedParams.serviceId }) });
}
