...
import { invokeNamedConversationAiAction } from '@alga-psa/tickets/actions/conversationAiActions';
...
export async function POST(request: NextRequest) {
  ...
  try {
    return NextResponse.json(await invokeNamedConversationAiAction(body.ticket, body.destination, body.request),
