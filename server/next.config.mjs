...
const nextConfig = {
  ...
  turbopack: {
    ...
    resolveAlias: {
      ...
      '@alga-psa/event-schemas/': '../packages/event-schemas/dist/',
      // Leaf horizontal packages (pre-built)
      ...
      '@alga-psa/validation/': '../packages/validation/dist/',
      '@alga-psa/formatting': '../packages/formatting/dist',
      '@alga-psa/formatting/': '../packages/formatting/dist/',
      // Documents package
  ...
  webpack: (config, { isServer, dev }) => {
    ...
    config.resolve.alias = {
      ...
      // Pre-built packages (resolve from dist/)
      ...
      '@alga-psa/formatting': path.join(__dirname, '../packages/formatting/dist'),
