...
const translations = {
  ...
  it: {
    ...
    'New Ticket Created for': 'Nuovo ticket creato per',
    'Ticket Assigned to': 'Ticket assegnato a',
    'Ticket Updated for': 'Ticket aggiornato per',
    'Ticket Closed for': 'Ticket chiuso per',
    'Ticket Comment Added for': 'Commento aggiunto al ticket per',
    'Ticket Created for': 'Ticket creato per',
    'Ticket Comment Added': 'Commento aggiunto al ticket',

    'A new ticket has been logged for': 'È stato registrato un nuovo ticket per',
    'Review the summary below and follow the link to take action.': 'Consulta il riepilogo qui sotto e segui il link per intervenire.',
    'You have been assigned to a ticket': 'Ti è stato assegnato un ticket',
    'A ticket has been updated': 'Un ticket è stato aggiornato',
    'A ticket has been closed': 'Un ticket è stato chiuso',
    ...
    'An invoice has been generated for': 'È stata emessa una fattura per',
    'Amount': 'Importo',
    'Due Date': 'Scadenza',
    'Payment has been received for invoice': 'È stato ricevuto un pagamento per la fattura',
    'Amount Paid': 'Importo pagato',
    'Payment Date': 'Data del pagamento',
    'Payment Method': 'Metodo di pagamento',
    'Payment is overdue for invoice': 'Il pagamento della fattura è in ritardo',
    'Amount Due': 'Importo dovuto',
    'Days Overdue': 'Giorni di ritardo',

    'Powered by Alga PSA': 'Offerto da Alga PSA',
    'Keeping teams aligned': 'Manteniamo i team allineati',
    'Powered by Alga PSA • Keeping teams aligned': 'Offerto da Alga PSA • Manteniamo i team allineati',

    'added a comment': 'ha aggiunto un commento',
    'Comment': 'Commento',

    // Tenant Recovery
    'Your Login Links': 'I tuoi link di accesso',
    'Hello,': 'Ciao,',
    'You requested access to your client portal': 'Hai richiesto l\'accesso al tuo portale clienti',
    'You requested access to your client portals': 'Hai richiesto l\'accesso ai tuoi portali clienti',
    'We found': 'Abbiamo trovato',
    'organizations associated with your email address': 'organizzazioni associate al tuo indirizzo email',
    'Here is your login link:': 'Ecco il tuo link di accesso:',
    'Sign In to': 'Accedi a',
    'Security Note:': 'Nota di sicurezza:',
    'If you didn\'t request these login links, you can safely ignore this email. Your account remains secure.': 'Se non hai richiesto questi link di accesso, puoi ignorare questa email in tutta sicurezza. Il tuo account rimane protetto.',
    'If you have any questions or need assistance, please contact your organization\'s support team.': 'Se hai domande o hai bisogno di assistenza, contatta il team di supporto della tua organizzazione.',
    'All rights reserved.': 'Tutti i diritti riservati.',
    'This is an automated message. Please do not reply to this email.': 'Questo è un messaggio automatico. Non rispondere a questa email.',

    // No Account Found
    'Access Request': 'Richiesta di accesso',
    'We received a request to access the client portal using this email address.': 'Abbiamo ricevuto una richiesta di accesso al portale clienti utilizzando questo indirizzo email.',
    'If you have an account with us, you should have received a separate email with your login links.': 'Se hai un account con noi, dovresti aver ricevuto un\'altra email con i tuoi link di accesso.',
    'If you didn\'t receive a login email, it may mean:': 'Se non hai ricevuto l\'email di accesso, potrebbe significare:',
    'This email address is not associated with any client portal accounts': 'Questo indirizzo email non è associato a nessun account del portale clienti',
    'Your account may be inactive': 'Il tuo account potrebbe essere inattivo',
    'The email may have been filtered to your spam folder': 'L\'email potrebbe essere finita nella cartella spam',
    'Need Help?': 'Hai bisogno di aiuto?',
    'If you believe you should have access to a client portal, please contact your service provider\'s support team for assistance.': 'Se ritieni di dover avere accesso a un portale clienti, contatta il team di supporto del tuo provider di servizi per assistenza.',
    'If you didn\'t request access, you can safely ignore this email.': 'Se non hai richiesto l\'accesso, puoi ignorare questa email in tutta sicurezza.'
  },
  es: {
...
const subjectTranslations = {
  ...
  it: {
    'ticket-created': 'Nuovo ticket • {{ticket.title}} ({{ticket.priority}})',
    'ticket-assigned': 'Ticket assegnato: {{ticket.title}}',
    'ticket-updated': 'Ticket aggiornato: {{ticket.title}}',
    'ticket-closed': 'Ticket chiuso: {{ticket.title}}',
    'ticket-comment-added': 'Nuovo commento: {{ticket.title}}',
    'invoice-generated': 'Nuova fattura {{invoice.number}}',
    'payment-received': 'Pagamento ricevuto: {{invoice.number}}',
    'payment-overdue': 'Pagamento in ritardo: {{invoice.number}}',
    'tenant-recovery': '{{platformName}} - I tuoi link di accesso',
    'no-account-found': '{{platformName}} - Richiesta di accesso'
  },
  nl: {
