...
const COPY = {
  en: { subject: 'Project budget exceeded: {{project.name}}', label: 'Project Budget Exceeded', intro: 'New billable work exceeded this project’s hard budget cap. The excess was written down.', billed: 'Billed', cap: 'Budget cap', writtenDown: 'Written down', button: 'Review project', footer: 'Powered by AlgaPSA' },
  ...
  es: { subject: 'Presupuesto del proyecto superado: {{project.name}}', label: 'Presupuesto del proyecto superado', intro: 'El nuevo trabajo facturable superó el límite presupuestario estricto de este proyecto. El exceso se dio de baja.', billed: 'Facturado', cap: 'Límite presupuestario', writtenDown: 'Dado de baja', button: 'Revisar proyecto', footer: 'Desarrollado por AlgaPSA' },
  de: { subject: 'Projektbudget überschritten: {{project.name}}', label: 'Projektbudget überschritten', intro: 'Neue abrechenbare Arbeit hat die feste Budgetobergrenze dieses Projekts überschritten. Der Überschuss wurde abgeschrieben.', billed: 'Abgerechnet', cap: 'Budgetobergrenze', writtenDown: 'Abgeschrieben', button: 'Projekt prüfen', footer: 'Bereitgestellt von AlgaPSA' },
  nl: { subject: 'Projectbudget overschreden: {{project.name}}', label: 'Projectbudget overschreden', intro: 'Nieuw factureerbaar werk heeft de harde budgetlimiet van dit project overschreden. Het meerdere is afgeschreven.', billed: 'Gefactureerd', cap: 'Budgetlimiet', writtenDown: 'Afgeschreven', button: 'Project bekijken', footer: 'Mogelijk gemaakt door AlgaPSA' },
