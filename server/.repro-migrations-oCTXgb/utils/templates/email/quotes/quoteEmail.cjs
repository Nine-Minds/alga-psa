...
const SUBJECTS = {
  ...
  es: 'Cotización {{quote.number}} de {{company.name}}',
...
const COPY = {
  ...
  es: {
    headerLabel: 'Cotización',
    headerMeta: 'De {{company.name}}',
    greeting: 'Hola:',
    intro: 'Su cotización de <strong>{{company.name}}</strong> está adjunta y lista para su revisión.',
    textIntro: 'Su cotización de {{company.name}} está adjunta y lista para su revisión.',
    ...
    attachmentNote: 'La cotización está adjunta a este correo en formato PDF. Si tiene alguna pregunta, no dude en contactarnos.',
    thankYou: 'Atentamente,',
    footer: 'Powered by AlgaPSA &middot; Manteniendo a los equipos alineados',
    textHeader: 'Cotización {{quote.number}} de {{company.name}}',
  ...
  pl: {
    ...
    intro: 'W załączeniu przesyłamy Państwa wycenę od <strong>{{company.name}}</strong> do zapoznania się.',
    textIntro: 'W załączeniu przesyłamy Państwa wycenę od {{company.name}} do zapoznania się.',
    ...
    attachmentNote: 'Wycena jest załączona do tej wiadomości w formacie PDF. W razie pytań prosimy o kontakt.',
    thankYou: 'Z poważaniem,',
    footer: 'Powered by AlgaPSA',
    textHeader: 'Wycena {{quote.number}} od {{company.name}}',
  ...
  pt: {
    ...
    headerMeta: 'De {{company.name}}',
    greeting: 'Olá,',
    intro: 'Segue em anexo a sua cotação de <strong>{{company.name}}</strong>, pronta para análise.',
    textIntro: 'Segue em anexo a sua cotação de {{company.name}}, pronta para análise.',
    ...
    attachmentNote: 'A cotação está anexada a este email como PDF. Se tiver alguma dúvida, entre em contato conosco.',
