...
Next implementation checkpoint: connect verified hosted/self-host entitlement reconciliation and sponsor-authorized provisioning to reservations, including failure cleanup and customer-admin acceptance. The reservation primitive has no public endpoint and starts no provisioning worker. Shared-work grants, consolidated queues, collaboration audiences, time/billing, provider SLAs, exit/export/upgrade, and the remaining end-to-end validation have not landed.
