# Getting Started with AlgaPSA

Choose the path that matches what you want to do:

- **Run AlgaPSA with prebuilt images** (evaluation or production-like
...
- **Develop AlgaPSA locally** (build from source, run tests, contribute
