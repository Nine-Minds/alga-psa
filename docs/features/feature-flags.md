...
edit and delete controls, including comment attachment pickers, staged new-message/reply file selection, and download links. New collaboration controls must use the same boundary.
