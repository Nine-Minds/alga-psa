...
describe('project quick add contact creation wiring contract', () => {
  it('T012: ProjectQuickAdd wires add-new contact to QuickAddContact with the selected client id', () => {
