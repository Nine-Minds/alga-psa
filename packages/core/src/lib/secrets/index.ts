/**
 * @alga-psa/core - Secrets Module
 *
 * Provides a unified interface for managing application and tenant secrets
 * with support for multiple backend providers (env, filesystem, vault).
 */
...
export { loadVaultSecretProvider } from './vaultLoader';

// Re-export getSecret from the server-only module for convenience
