...
import { IAnalyticsTracker } from '@shared/models/ticketModel';
import { analytics, AnalyticsEvents, featureAdoptionTracker } from '@alga-psa/analytics';

export class ServerAnalyticsTracker implements IAnalyticsTracker {
