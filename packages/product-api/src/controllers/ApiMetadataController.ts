...
import { MetadataService } from '@product/api/services/MetadataService';
import { DatabaseService } from '@product/api/services/DatabaseService';
import { EventBusService } from '@product/api/services/EventBusService';
import { 
  metadataQuerySchema,
...
} from '@product/api/schemas/metadataSchemas';
import { ApiKeyServiceForApi } from '@server/lib/services/apiKeyServiceForApi';
import { findUserByIdForApi } from '@product/actions/user-actions/findUserByIdForApi';
    ...
    return async (req: NextRequest): Promise<NextResponse> => {
      try {
        ...
        return await runWithTenant(apiRequest.context!.tenant, async () => {
          ...
          const { SdkGeneratorService } = await import('@product/api/services/SdkGeneratorService');
