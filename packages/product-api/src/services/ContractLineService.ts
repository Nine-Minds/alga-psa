...
import { cloneTemplateContractLine } from '@server/lib/billing/utils/templateClone';

// Import existing models and actions for integration
import ContractLine from '@server/lib/models/contractLine';
import ContractLineFixedConfig from '@server/lib/models/contractLineFixedConfig';
import ContractLineMapping from '@server/lib/models/contractLineMapping';
import { ContractLineServiceConfigurationService } from '@server/lib/services/contractLineServiceConfigurationService';
...
} from '@product/api/schemas/contractLineSchemas';
