import type { BaseService as ControllerBaseService, ListOptions } from '@product/api/controllers/types';
...
import type { CreateServiceRequest, UpdateServiceRequest } from '@product/api/schemas/serviceSchemas';
