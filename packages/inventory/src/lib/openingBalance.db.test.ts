/**
 * Opening-balance CSV integration tests against the isolated migrated test DB.
...
describe('opening balance validation and apply (isolated migrated DB, rolled back)', () => {
