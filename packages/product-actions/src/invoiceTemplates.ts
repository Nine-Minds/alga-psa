...
import Invoice from '@server/lib/models/invoice'; // Assuming Invoice model has template methods
import {
    IInvoiceTemplate,
    ICustomField,
    IConditionalRule,
...
import { executeWasmTemplate } from '@server/lib/invoice-renderer/wasm-executor';
import { renderLayout } from '@server/lib/invoice-renderer/layout-renderer';
import type { WasmInvoiceViewModel, RenderOutput } from '@server/lib/invoice-renderer/types';
