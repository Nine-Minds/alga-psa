...
import type { EmailProvider, MicrosoftEmailProviderConfig, GoogleEmailProviderConfig } from '@server/components/EmailProviderConfiguration';
import { getSecretProviderInstance } from '@shared/core';
import { setupPubSub } from './setupPubSub';
import { EmailProviderService } from '@server/services/email/EmailProviderService';
...
//     const { generateMicrosoftAuthUrl, generateGoogleAuthUrl, generateNonce } = await import('@product/actions/../../utils/email/oauthHelpers');
//     type OAuthState = import('@product/actions/../../utils/email/oauthHelpers').OAuthState;
