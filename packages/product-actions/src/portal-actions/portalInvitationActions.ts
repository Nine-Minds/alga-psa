...
import { createTenantKnex, runWithTenant } from '@server/lib/db';
import { getCurrentUser } from '@product/actions/user-actions/userActions';
import { PortalInvitationService } from '@server/lib/services/PortalInvitationService';
import { sendPortalInvitationEmail } from '@server/lib/email/sendPortalInvitationEmail';
import { getSystemEmailService } from '@server/lib/email';
import { TenantEmailService } from '@server/lib/services/TenantEmailService';
import { UserService } from '@product/api/services/UserService';
import { runAsSystem, createSystemContext } from '@product/api/services/SystemContext';
...
export async function createClientPortalUser(
  ...
  try {
    ...
    const result = await knex.transaction(async (trx) => {
      ...
      const { hashPassword } = await import('@server/utils/encryption/encryption');
