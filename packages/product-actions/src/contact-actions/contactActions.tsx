...
import { getContactAvatarUrl } from '@server/lib/utils/avatarUtils';
...
export async function getContactsEligibleForInvitation(
  ...
  const { getCurrentUser } = await import('@product/actions/user-actions/userActions');
  const { hasPermission } = await import('@server/lib/auth/rbac');
