...
import { toISODate } from '@server/lib/utils/dateTimeUtils';
// import { auditLog } from '@server/lib/logging/auditLog';
import ClientContractLine from '@server/lib/models/clientContractLine';
import { applyCreditToInvoice } from '@product/actions/creditActions'; // Assuming this stays or moves appropriately
...
import { persistInvoiceItems, persistManualInvoiceItems } from '@server/lib/services/invoiceService'; // Import persistManualInvoiceItems
import Invoice from '@server/lib/models/invoice'; // Needed for getFullInvoiceById
...
import { getEventBus } from '@server/lib/eventBus'; // Import EventBus
