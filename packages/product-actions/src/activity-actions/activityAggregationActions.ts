...
} from "@server/interfaces/activity.interfaces";
import ScheduleEntry from "@server/lib/models/scheduleEntry";
...
import { IProjectTask } from "@server/interfaces/project.interfaces";
