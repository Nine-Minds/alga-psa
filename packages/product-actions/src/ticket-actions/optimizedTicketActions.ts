...
import { convertBlockNoteToMarkdown } from '@server/lib/utils/blocknoteUtils';
import { getImageUrl } from '@product/actions/document-actions/documentActions';
import { getClientLogoUrl, getUserAvatarUrl, getClientLogoUrlsBatch } from '@server/lib/utils/avatarUtils';
import {
  ticketFormSchema,
  ticketSchema,
  ticketUpdateSchema, 
