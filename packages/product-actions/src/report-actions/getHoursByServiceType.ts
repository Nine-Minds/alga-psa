...
import { ITimeEntry } from '@server/interfaces/timeEntry.interfaces';
import { IService, IServiceType } from '@server/interfaces/billing.interfaces';
import { ITicket } from '@server/interfaces/ticket.interfaces'; // Removed .tsx extension
import { IProjectTask, IProject, IProjectPhase } from '@server/interfaces/project.interfaces';
import { toPlainDate } from '@server/lib/utils/dateTimeUtils'; // Assuming this utility exists for date handling
