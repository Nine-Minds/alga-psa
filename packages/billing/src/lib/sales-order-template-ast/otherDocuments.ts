    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              { id: 'title', type: 'text', content: { type: 'i18n', i18nKey: 'labels.packingSlipTitle', defaultValue: 'PACKING SLIP' }, style: { inline: { fontSize: '20px', fontWeight: 700, margin: '0 0 4px 0' } } },
              ...
              { id: 'expected-ship', type: 'field', label: { i18nKey: 'labels.shipDate', defaultValue: 'Ship Date' }, binding: { bindingId: 'expectedShipDate' }, format: 'date', emptyValue: '-', style: { inline: { justifyContent: 'space-between' } } },
      ...
      { id: 'divider', type: 'divider', style: { inline: { margin: '0 0 20px 0' } } },
      {
        ...
        children: [
          { id: 'ship-to-label', type: 'text', content: { type: 'i18n', i18nKey: 'labels.shipTo', defaultValue: 'Ship To' }, style: { inline: { color: '#6b7280', fontSize: '12px', fontWeight: 700 } } },
      ...
      },
      {
        ...
        columns: [
          { id: 'product', header: { i18nKey: 'labels.product', defaultValue: 'Product' }, value: { type: 'path', path: 'description' }, style: { inline: { width: '40%' } } },
          { id: 'sku', header: { i18nKey: 'labels.sku', defaultValue: 'SKU' }, value: { type: 'path', path: 'service_sku' }, style: { inline: { width: '20%' } } },
          { id: 'fulfillment', header: { i18nKey: 'labels.source', defaultValue: 'Source' }, value: { type: 'path', path: 'fulfillment_type' }, style: { inline: { width: '16%' } } },
          { id: 'ordered', header: { i18nKey: 'labels.ordered', defaultValue: 'Ordered' }, value: { type: 'path', path: 'quantity_ordered' }, format: 'number', style: { inline: { textAlign: 'right', width: '12%' } } },
          { id: 'shipped', header: { i18nKey: 'labels.shipped', defaultValue: 'Shipped' }, value: { type: 'path', path: 'quantity_fulfilled' }, format: 'number', style: { inline: { textAlign: 'right', width: '12%' } } },
        ],
      },
      { id: 'notes-section', type: 'section', title: { i18nKey: 'labels.notes', defaultValue: 'Notes' }, children: [
    ...
    children: [
      {
        ...
        children: [
          { id: 'title', type: 'text', content: { type: 'i18n', i18nKey: 'labels.pickListTitle', defaultValue: 'PICK LIST' }, style: { inline: { fontSize: '22px', fontWeight: 700 } } },
          { id: 'order-number', type: 'field', label: { i18nKey: 'labels.orderNumber', defaultValue: 'Order #' }, binding: { bindingId: 'orderNumber' }, style: { inline: { justifyContent: 'flex-end', gap: '6px' } } },
        ],
      },
