  ...
  layout: {
    ...
    children: [
      // ── Header: logo + order meta card ────────────────────────────
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              { id: 'order-title', type: 'text', content: { type: 'i18n', i18nKey: 'labels.orderConfirmationTitle', defaultValue: 'ORDER CONFIRMATION' }, style: { inline: { fontSize: '20px', fontWeight: 700, margin: '0 0 4px 0', lineHeight: 1.1 } } },
              { id: 'order-number', type: 'field', label: { i18nKey: 'labels.orderNumber', defaultValue: 'Order #' }, binding: { bindingId: 'orderNumber' }, style: { inline: { justifyContent: 'space-between' } } },
              { id: 'order-date', type: 'field', label: { i18nKey: 'labels.orderDate', defaultValue: 'Order Date' }, binding: { bindingId: 'orderDate' }, format: 'date', style: { inline: { justifyContent: 'space-between' } } },
              { id: 'expected-ship', type: 'field', label: { i18nKey: 'labels.expectedShip', defaultValue: 'Expected Ship' }, binding: { bindingId: 'expectedShipDate' }, format: 'date', emptyValue: '-', style: { inline: { justifyContent: 'space-between' } } },
              { id: 'po-number', type: 'field', label: { i18nKey: 'labels.yourPoNumber', defaultValue: 'Your PO #' }, binding: { bindingId: 'poNumber' }, emptyValue: '-', style: { inline: { justifyContent: 'space-between' } } },
            ],
          },
        ],
      },
      ...
      // ── Party blocks: From / Ship To ──────────────────────────────
      {
        ...
        children: [
          ...
          },
          {
            ...
            style: { inline: { flex: '1', gap: '4px', border: '1px solid #e5e7eb', borderRadius: '10px', padding: '12px 14px' } },
            children: [
              { id: 'ship-to-label', type: 'text', content: { type: 'i18n', i18nKey: 'labels.shipTo', defaultValue: 'Ship To' }, style: { inline: { color: '#6b7280', fontSize: '12px', fontWeight: 700, margin: '0 0 2px 0' } } },
      ...
      // ── Line items table ──────────────────────────────────────────
      {
        ...
        emptyStateText: { i18nKey: 'labels.emptyState.noItemsOnOrder', defaultValue: 'No items on this order' },
        columns: [
          { id: 'product', header: { i18nKey: 'labels.product', defaultValue: 'Product' }, value: { type: 'path', path: 'description' }, style: { inline: { width: '46%' } } },
          { id: 'sku', header: { i18nKey: 'labels.sku', defaultValue: 'SKU' }, value: { type: 'path', path: 'service_sku' }, style: { inline: { width: '18%' } } },
          { id: 'quantity', header: { i18nKey: 'labels.qty', defaultValue: 'Qty' }, value: { type: 'path', path: 'quantity_ordered' }, format: 'number', style: { inline: { textAlign: 'right', width: '10%' } } },
          { id: 'unit-price', header: { i18nKey: 'labels.unitPrice', defaultValue: 'Unit Price' }, value: { type: 'path', path: 'unit_price' }, format: 'currency', style: { inline: { textAlign: 'right', width: '13%' } } },
          { id: 'amount', header: { i18nKey: 'labels.amount', defaultValue: 'Amount' }, value: { type: 'path', path: 'amount' }, format: 'currency', style: { inline: { textAlign: 'right', width: '13%' } } },
        ],
      },
        ...
        children: [
          {
            ...
            rows: [
              ...
              { id: 'order-total', label: { i18nKey: 'labels.orderTotal', defaultValue: 'Order Total' }, value: { type: 'binding', bindingId: 'total' }, format: 'currency', emphasize: true },
            ],
          },
        ],
      },
      // ── Tax note ──────────────────────────────────────────────────
      {
        id: 'tax-note',
        type: 'text',
        content: { type: 'i18n', i18nKey: 'labels.note.preTaxTotals', defaultValue: 'Totals shown are pre-tax. Applicable tax is calculated on your invoice.' },
      ...
      // ── Notes ─────────────────────────────────────────────────────
      {
        id: 'notes-section',
        type: 'section',
        title: { i18nKey: 'labels.notes', defaultValue: 'Notes' },
        children: [
      ...
      // ── Footer ────────────────────────────────────────────────────
      {
        id: 'footer-thanks',
        type: 'text',
        content: { type: 'i18n', i18nKey: 'labels.note.thankYouForOrder', defaultValue: 'Thank you for your order.' },
...
const buildStandardSalesOrderDetailedAst = (): TemplateAst => {
  ...
  if (lineItems) {
    lineItems.columns = [
      { id: 'product', header: { i18nKey: 'labels.product', defaultValue: 'Product' }, value: { type: 'path', path: 'description' }, style: { inline: { width: '34%' } } },
      { id: 'sku', header: { i18nKey: 'labels.sku', defaultValue: 'SKU' }, value: { type: 'path', path: 'service_sku' }, style: { inline: { width: '14%' } } },
      { id: 'fulfillment', header: { i18nKey: 'labels.fulfillment', defaultValue: 'Fulfillment' }, value: { type: 'path', path: 'fulfillment_type' }, style: { inline: { width: '14%' } } },
      { id: 'ordered', header: { i18nKey: 'labels.ordered', defaultValue: 'Ordered' }, value: { type: 'path', path: 'quantity_ordered' }, format: 'number', style: { inline: { textAlign: 'right', width: '9%' } } },
      { id: 'fulfilled', header: { i18nKey: 'labels.fulfilled', defaultValue: 'Fulfilled' }, value: { type: 'path', path: 'quantity_fulfilled' }, format: 'number', style: { inline: { textAlign: 'right', width: '9%' } } },
      { id: 'unit-price', header: { i18nKey: 'labels.unitPrice', defaultValue: 'Unit Price' }, value: { type: 'path', path: 'unit_price' }, format: 'currency', style: { inline: { textAlign: 'right', width: '10%' } } },
      { id: 'amount', header: { i18nKey: 'labels.amount', defaultValue: 'Amount' }, value: { type: 'path', path: 'amount' }, format: 'currency', style: { inline: { textAlign: 'right', width: '10%' } } },
    ];
  }
  return ast;
};
