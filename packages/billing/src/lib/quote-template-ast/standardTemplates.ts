...
type QuoteColumnShape = {
  id: string;
  value: { type: 'path'; path: string };
  style?: unknown;
  lines?: unknown[];
};

const QUOTE_ITEM_NAME_LINE = {
  id: 'item-name',
  value: { type: 'path', path: 'service_name' },
  style: { inline: { fontWeight: 600, lineHeight: 1.3 } },
};

const QUOTE_CATALOG_DESCRIPTION_LINE = {
 ...
 * rendering their line text instead of showing an empty cell. Layouts bind
 * `description`, `service_name`, or `catalog_description` independently.
 */
      ...
      // ── Party blocks: From / Prepared For ─────────────────────────
      {
        ...
        children: [
          ...
          },
          {
            ...
            style: { inline: { flex: '1', gap: '4px', border: '1px solid #e5e7eb', borderRadius: '10px', padding: '12px 14px' } },
            children: [
              { id: 'prepared-for-label', type: 'text', content: { type: 'i18n', i18nKey: 'labels.preparedFor', defaultValue: 'Prepared For' }, style: { inline: { color: '#6b7280', fontSize: '12px', fontWeight: 700, margin: '0 0 2px 0' } } },
        ...
        children: [
          {
            ...
            children: [
              { id: 'sig-client-label', type: 'text', content: { type: 'i18n', i18nKey: 'labels.acceptedBy', defaultValue: 'Accepted By' }, style: { inline: { color: '#6b7280', fontSize: '12px', fontWeight: 700 } } },
          ...
          },
          {
            ...
            style: { inline: { flex: '1', gap: '4px' } },
            children: [
              { id: 'sig-issuer-label', type: 'text', content: { type: 'i18n', i18nKey: 'labels.authorizedBy', defaultValue: 'Authorized By' }, style: { inline: { color: '#6b7280', fontSize: '12px', fontWeight: 700 } } },
              { id: 'sig-issuer-line', type: 'divider', style: { inline: { margin: '24px 0 4px 0', borderColor: '#000' } } },
              { id: 'sig-issuer-name', type: 'text', content: { type: 'i18n', i18nKey: 'labels.signature', defaultValue: 'Signature' }, style: { inline: { color: '#9ca3af', fontSize: '12px' } } },
              { id: 'sig-issuer-date-line', type: 'divider', style: { inline: { margin: '20px 0 4px 0', borderColor: '#000' } } },
              { id: 'sig-issuer-date', type: 'text', content: { type: 'i18n', i18nKey: 'labels.date', defaultValue: 'Date' }, style: { inline: { color: '#9ca3af', fontSize: '12px' } } },
            ],
          },
        ],
      },
  ...
  layout: {
    ...
    children: [
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { id: 'valid-until', type: 'field', label: { i18nKey: 'labels.validUntil', defaultValue: 'Valid Until' }, binding: { bindingId: 'validUntil' }, format: 'date', style: { inline: { justifyContent: 'space-between' } } },
              { id: 'po-number', type: 'field', label: { i18nKey: 'labels.poNumber', defaultValue: 'PO #' }, binding: { bindingId: 'poNumber' }, emptyValue: '-', style: { inline: { justifyContent: 'space-between' } } },
              { id: 'version', type: 'field', label: { i18nKey: 'labels.version', defaultValue: 'Version' }, binding: { bindingId: 'version' }, style: { inline: { justifyContent: 'space-between' } } },
            ],
          },
        ],
      },
      ...
      // ── Phase summary table ───────────────────────────────────────
      {
        ...
        emptyStateText: { i18nKey: 'labels.emptyState.noPhasesDefined', defaultValue: 'No phases defined' },
        columns: [
          { id: 'phase-name', header: { i18nKey: 'labels.projectPhase', defaultValue: 'Project Phase' }, value: { type: 'path', path: 'name' }, style: { inline: { width: '100%' } } },
        ],
      },
      // ── Detailed line items table ─────────────────────────────────
      {
        ...
        emptyStateText: { i18nKey: 'labels.emptyState.noLineItems', defaultValue: 'No line items' },
        columns: [
          withItemDescriptionLines({ id: 'description', header: { i18nKey: 'labels.description', defaultValue: 'Description' }, value: { type: 'path', path: 'description' }, style: { inline: { width: '36%' } } }),
          ...
          { id: 'quantity', header: { i18nKey: 'labels.qty', defaultValue: 'Qty' }, value: { type: 'path', path: 'quantity' }, format: 'number', style: { inline: { textAlign: 'right', width: '8%' } } },
          { id: 'unit-price', header: { i18nKey: 'labels.rate', defaultValue: 'Rate' }, value: { type: 'path', path: 'unit_price' }, format: 'currency', style: { inline: { textAlign: 'right', width: '13%' } } },
          { id: 'amount', header: { i18nKey: 'labels.amount', defaultValue: 'Amount' }, value: { type: 'path', path: 'total_price' }, format: 'currency', style: { inline: { textAlign: 'right', width: '13%' } } },
        ],
      },
      // ── Totals ────────────────────────────────────────────────────
      {
      ...
      // `path` expressions (which resolve against `scope.row`).
      {
        ...
        children: [
          ...
          },
          {
            ...
            emptyStateText: { i18nKey: 'labels.emptyState.noLineItems', defaultValue: 'No line items' },
            columns: [
              withItemDescriptionLines({ id: 'description', header: { i18nKey: 'labels.description', defaultValue: 'Description' }, value: { type: 'path', path: 'description' }, style: { inline: { width: '52%' } } }),
