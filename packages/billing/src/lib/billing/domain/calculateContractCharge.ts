      ...
      facts = {
        ...
        activity: charge.inputs.timeEntries.map((entry) => ({
          ...
          workItem: {
            ...
            sourceTenant: entry.work_source_tenant,
            sourceKind: entry.work_source_kind,
            sourceId: entry.work_source_id,
            relationshipId: entry.work_relationship_id,
      ...
      obligation = {
        ...
        inputs: {
          ...
          timeEntries: facts.activity.map((entry) => ({
            ...
            work_item_type: entry.workItem?.type,
            work_source_tenant: entry.workItem?.sourceTenant,
            work_source_kind: entry.workItem?.sourceKind,
            work_source_id: entry.workItem?.sourceId,
            work_relationship_id: entry.workItem?.relationshipId,
            ticket_number: entry.workItem?.ticketNumber,
            ticket_title: entry.workItem?.ticketTitle,
            ticket_description: entry.workItem?.ticketDescription,
            project_task_name: entry.workItem?.projectTaskName,
          })),
