            ...
            <section className="rounded-lg border border-border bg-background p-5 shadow-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="flex flex-col gap-1 text-sm font-medium">
                  ...
                  <Input id="quote-monthly-section-title" value={form.recurring_section_title} placeholder={t('documents:labels.monthlyItems', { defaultValue: 'Monthly Items' })} onChange={(event) => handleChange('recurring_section_title', event.target.value)} disabled={isReadOnly} />
                </label>
                <label className="flex flex-col gap-1 text-sm font-medium">
                  {t('quoteForm.sectionTitles.oneTimeLabel', { defaultValue: 'One-time section title' })}
                  <Input id="quote-onetime-section-title" value={form.onetime_section_title} placeholder={t('documents:labels.oneTimeItems', { defaultValue: 'One-time Items' })} onChange={(event) => handleChange('onetime_section_title', event.target.value)} disabled={isReadOnly} />
                </label>
              </div>
            </section>
