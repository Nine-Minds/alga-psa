...
// --- View DTOs (shared by billing actions and cross-feature UI composition) ---
...
export interface ProjectBillingPhaseRateOverrideView extends IProjectPhaseRateOverride {
  phase_name: string;
