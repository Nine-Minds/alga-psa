...
export async function coManagedInternalEmailRecipient(context: { trx: Knex.Transaction; actor: { tenant: string; userId: string } }, subtypeName: 'Ticket Comment Added' | 'Ticket Assigned' | 'Ticket Closed' | 'Task Comment Added' | 'SLA Warning' | 'SLA Breach' = 'Ticket Comment Added') {
...
export async function coManagedCommentEmailSettings(trx: Knex.Transaction, tenant: string, subtypeName: 'Ticket Comment Added' | 'Ticket Assigned' | 'Ticket Closed' | 'Task Comment Added' | 'SLA Warning' | 'SLA Breach' = 'Ticket Comment Added') {
