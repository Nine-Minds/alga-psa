...
describe('tag model tenant-scoped query contract', () => {
  it('uses structural tenant scoping for tag definition roots', () => {
    expect(tagDefinitionSource).toContain("table: 'tag_definitions'");
    expect(tagDefinitionSource).toContain("table: 'tag_mappings'");
  ...
  it('uses structural tenant scoping for tag mapping roots and aliases', () => {
    expect(tagMappingSource).toContain("table: 'tag_mappings'");
    expect(tagMappingSource).toContain("table: 'tag_mappings as tm'");
    expect(tagMappingSource).toContain("alias: 'tm'");
