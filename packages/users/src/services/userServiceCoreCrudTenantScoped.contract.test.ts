...
describe('user service core CRUD tenant-scoped query contract', () => {
  it('uses structural tenant scoping for get/create/update read and mutation roots', () => {
    const section = sectionBetween('async getById', 'async delete');
