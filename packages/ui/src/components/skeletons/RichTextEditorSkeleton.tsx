    ...
    <div className="animate-pulse border rounded-lg overflow-hidden bg-white dark:bg-[rgb(var(--color-border-100))]">
        ...
        <div className="border-b bg-gray-50 dark:bg-[rgb(var(--color-border-50))] p-2">
          <div className="flex items-center space-x-1">
            ...
            <div className="flex items-center space-x-1 mr-3">
              ...
              <div className="h-6 w-px skeleton-fill-strong mx-1"></div>
            ...
            {/* Separator */}
            <div className="h-6 w-px skeleton-fill-strong mx-2"></div>
      ...
      <div className="relative overflow-hidden" style={{ height }}>
        ...
        <div className="absolute top-4 left-4">
          <div className="w-px h-4 skeleton-fill-strong animate-pulse"></div>
        </div>
