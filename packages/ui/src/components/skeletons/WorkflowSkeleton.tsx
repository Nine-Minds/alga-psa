  ...
  return (
    <div className="workflow-visualizer relative animate-pulse" style={{ height, width }}>
      ...
      <div className="absolute inset-0 bg-[rgb(var(--color-border-50))] border rounded-lg">
        ...
        <div className="absolute top-24 left-36 w-20 h-12 skeleton-fill-strong rounded-lg"></div>
        <div className="absolute top-24 left-64 w-20 h-12 bg-red-200 rounded-lg"></div>
        
        {/* Simulated connection lines */}
        <div className="absolute top-14 left-28 w-8 h-0.5 skeleton-fill-strong"></div>
        <div className="absolute top-14 left-56 w-8 h-0.5 skeleton-fill-strong"></div>
        <div className="absolute top-20 left-42 w-0.5 h-4 skeleton-fill-strong"></div>
        <div className="absolute top-30 left-56 w-8 h-0.5 skeleton-fill-strong"></div>
      ...
      {showControls && (
        <div className="absolute top-4 right-4 flex flex-col gap-2">
          <div className="w-10 h-10 skeleton-fill rounded-md shadow-sm"></div>
          <div className="w-10 h-10 skeleton-fill rounded-md shadow-sm"></div>
          <div className="w-10 h-10 skeleton-fill rounded-md shadow-sm"></div>
        </div>
      )}
        ...
        <div className="absolute bottom-4 right-4 bg-[rgb(var(--color-card))] p-3 rounded-md shadow-md border border-[rgb(var(--color-border-200))] w-40">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <div className="h-3 skeleton-fill rounded flex-1"></div>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 skeleton-fill-strong rounded"></div>
              <div className="h-3 skeleton-fill rounded flex-1"></div>
      ...
      {/* Minimap skeleton */}
      <div className="absolute bottom-4 left-4 w-24 h-16 skeleton-fill rounded border shadow-sm"></div>
