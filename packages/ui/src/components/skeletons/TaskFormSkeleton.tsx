  ...
  return (
    <div className="animate-pulse max-h-[90vh] overflow-y-auto">
      <div className="space-y-4">
        {/* Full width Title */}
        <div>
          <div className="h-4 skeleton-fill rounded w-24 mb-1"></div>
          <div className="h-12 skeleton-fill rounded w-full"></div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <div className="h-4 skeleton-fill rounded w-28 mb-1"></div>
            <div className="h-9 skeleton-fill rounded w-full"></div>
          </div>
          <div>
            <div className="h-4 skeleton-fill rounded w-24 mb-1"></div>
        ...
        {isEdit && (
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className="h-5 skeleton-fill rounded w-12"></div>
            </div>
            <div className="flex gap-2">
              <div className="h-6 skeleton-fill rounded-full px-3 py-1 w-20"></div>
              <div className="h-6 skeleton-fill rounded-full px-3 py-1 w-24"></div>
              <div className="h-6 w-6 skeleton-fill rounded"></div>
            </div>
          </div>
        )}
          ...
          <div className="space-y-2">
            {Array.from({ length: 2 }, (_, i) => (
              <div key={i} className="flex items-center gap-2">
                ...
                <div className="h-4 skeleton-fill rounded w-48"></div>
              </div>
            ))}
          </div>
        </div>
        ...
        {isEdit && (
          <div>
            ...
            <div className="h-9 skeleton-fill rounded w-32"></div>
          </div>
        )}
        ...
        <div className="flex justify-between mt-6 pt-4 border-t">
          ...
          <div className="flex gap-2">
            {isEdit && (
              <div className="h-9 skeleton-fill rounded w-36"></div>
            )}
            <div className="h-9 skeleton-fill rounded w-20"></div>
          </div>
        </div>
