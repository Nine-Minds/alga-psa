      ...
      <TooltipPrimitive.Root open={open} onOpenChange={onOpenChange} delayDuration={delayDuration}>
        ...
        <TooltipPrimitive.Portal>
          <TooltipPrimitive.Content
            ...
            align={align}
            className={cn(
              "z-[9999] overflow-hidden rounded-md px-2.5 py-1.5 text-xs font-medium text-[rgb(var(--color-text-50))] bg-[rgb(var(--color-text-800))] dark:bg-[rgb(var(--color-border-100))] dark:text-[rgb(var(--color-text-900))] dark:border dark:border-[rgb(var(--color-border-300))] shadow-md",
