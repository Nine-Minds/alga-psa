    ...
    return (
      ...
      >
        ...
        <div
          ...
          tabIndex={-1}
          className={`relative bg-[rgb(var(--color-card))] rounded-lg shadow-lg border border-[rgb(var(--color-primary-200))] w-full ${className || 'max-w-3xl'} max-h-[90%] flex flex-col focus:outline-none`}
        >
          {/* Title bar */}
          {title ? (
