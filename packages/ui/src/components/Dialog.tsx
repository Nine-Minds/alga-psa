    ...
    return (
      ...
      >
        ...
        <div
          ...
          tabIndex={-1}
          className={`relative bg-[rgb(var(--color-card))] rounded-lg shadow-lg w-full ${className || 'max-w-3xl'} max-h-[90%] flex flex-col focus:outline-none focus-within:ring-2 focus-within:ring-primary-100 focus-within:ring-offset-2 focus-within:ring-offset-[rgb(var(--color-card))]`}
        >
          {/* Title bar */}
          {title ? (
    ...
    >
      <RadixDialog.Portal>
        ...
        <RadixDialog.Content
          ...
          className={`fixed top-1/2 left-1/2 bg-[rgb(var(--color-card))] rounded-lg shadow-lg w-full ${className || 'max-w-3xl'} z-50 focus-within:ring-2 focus-within:ring-primary-100 focus-within:ring-offset-2 focus-within:ring-offset-[rgb(var(--color-card))] max-h-[90vh] flex flex-col`}
          style={dialogStyle}
          onKeyDown={(e) => {
