...
const ClientDetails: React.FC<ClientDetailsProps> = ({
  ...
  const { renderQuickAddTicket, getTicketFormOptions, renderSurveySummaryCard, renderClientAssets, renderClientOpportunities, renderClientTickets, renderHourBlocksSection, getSlaPolicies, openTicketDetails } = useClientCrossFeature();
