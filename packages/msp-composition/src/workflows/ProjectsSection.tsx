...
import { ProjectTaskCard } from '@alga-psa/workflows/components/user-activities/ActivityCard';
import { fetchProjectActivities } from '@alga-psa/workflows/actions';
import { ProjectSectionFiltersDialog } from '@alga-psa/workflows/components/user-activities/filters/ProjectSectionFiltersDialog';
...
import { useActivityDrawer } from '@alga-psa/workflows/components/user-activities/ActivityDrawerProvider';
