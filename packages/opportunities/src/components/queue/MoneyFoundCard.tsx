...
export function MoneyFoundCard({ item, onAccept, onDismiss, onSnooze, onViewEvidence }: MoneyFoundCardProps) {
  ...
  return (
    <div
      id={idBase}
      className="flex flex-col rounded-xl border border-[rgb(var(--color-border-200))] bg-[rgb(var(--color-card))] p-4 transition-colors hover:border-[rgb(var(--color-primary-300))]"
    >
