...
describe('document preview and content tenant-scoped query contract', () => {
  it('uses structural tenant scoping for preview/content helper roots', () => {
    ...
    expect(combined).toContain("table: 'document_block_content'");
    expect(combined).toContain("table: 'document_content'");
    expect(combined).toContain("table: 'document_associations'");
    expect(combined).toContain("table: 'document_folders'");
    expect(combined).toContain("table: 'documents'");
    expect(combined).toContain("table: 'external_files'");
