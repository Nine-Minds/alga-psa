      ...
      <div className="bg-[rgb(var(--color-card))] rounded-lg border border-[rgb(var(--color-border-200))] shadow-sm p-4 h-full flex flex-col">
        <div className="flex-1">
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1 min-w-0 mr-2">
              <div className="flex items-center space-x-2">
                {/* Icon skeleton */}
                <div className="w-6 h-6 skeleton-fill rounded-md animate-pulse"></div>
                {/* Title skeleton */}
                <div className="h-5 skeleton-fill rounded-md w-3/4 animate-pulse"></div>
              </div>
              {/* Author and date skeleton */}
              <div className="mt-1 h-3 skeleton-fill rounded-md w-2/3 animate-pulse"></div>
              {/* Type skeleton */}
              <div className="mt-1 h-3 skeleton-fill rounded-md w-1/2 animate-pulse"></div>
            </div>
          </div>
          ...
          <div className="space-y-1">
            {/* Mime type skeleton */}
            <div className="h-3 skeleton-fill rounded-md w-1/3 animate-pulse"></div>
            {/* File size skeleton */}
            <div className="h-3 skeleton-fill rounded-md w-1/4 animate-pulse"></div>
          </div>

          {/* Preview content skeleton */}
          <div className="mt-4 preview-container">
            <div
              className="skeleton-fill rounded-md animate-pulse"
        ...
        <div className="mt-4 pt-3 flex flex-col space-y-1.5 items-end border-t border-[rgb(var(--color-border-100))]">
          ...
          <div className="h-8 skeleton-fill rounded-md w-24 animate-pulse"></div>
          {/* Delete button skeleton */}
          <div className="h-8 skeleton-fill rounded-md w-20 animate-pulse"></div>
        </div>
      </div>
    </ReflectionContainer>
  );
...
export default function DocumentsPageSkeleton(): React.JSX.Element {
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="h-8 w-48 skeleton-fill rounded-md animate-pulse"></div>
      </div>
        ...
        <div className="w-80">
          <div className="bg-[rgb(var(--color-card))] rounded-lg border border-[rgb(var(--color-border-200))] shadow-sm p-4">
            <div className="space-y-4">
              ...
              <div>
                <div className="h-5 w-32 skeleton-fill rounded-md animate-pulse mb-2"></div>
                <div className="h-10 w-full skeleton-fill rounded-md animate-pulse"></div>
              </div>
              ...
              <div>
                <div className="h-5 w-40 skeleton-fill rounded-md animate-pulse mb-2"></div>
                <div className="h-10 w-full skeleton-fill rounded-md animate-pulse"></div>
              </div>
              
              {/* User filter skeleton */}
              <div>
                <div className="h-5 w-28 skeleton-fill rounded-md animate-pulse mb-2"></div>
                <div className="h-10 w-full skeleton-fill rounded-md animate-pulse"></div>
              </div>
              
              {/* Date filter skeletons */}
              <div>
                <div className="h-5 w-36 skeleton-fill rounded-md animate-pulse mb-2"></div>
                <div className="h-10 w-full skeleton-fill rounded-md animate-pulse"></div>
              </div>
              ...
              <div>
                <div className="h-5 w-20 skeleton-fill rounded-md animate-pulse mb-2"></div>
                <div className="flex items-center space-x-2">
                  <div className="h-10 flex-1 skeleton-fill rounded-md animate-pulse"></div>
                  <div className="h-10 w-10 skeleton-fill rounded-md animate-pulse"></div>
                </div>
              </div>
