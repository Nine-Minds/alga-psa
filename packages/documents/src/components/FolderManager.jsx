...
export default function FolderManager({ open, onClose, currentFolder, onFolderCreated }) {
      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input id="folder-name-input" value={folderName} onChange={(e) => setFolderName(e.target.value)} placeholder={t('documents.folderManager.namePlaceholder', 'Enter folder name')} onKeyPress={(e) => e.key === 'Enter' && handleCreate()}/>
          </div>

          {currentFolder && (<div className="text-sm text-gray-500">
