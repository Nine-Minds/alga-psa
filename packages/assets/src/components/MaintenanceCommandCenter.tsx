...
export function MaintenanceCommandCenter() {
  ...
  return <div className="h-full min-h-0 overflow-auto bg-[rgb(var(--color-background))] p-4 md:p-6" data-automation-id="maintenance-command-center">
    ...
    <div className="mb-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-5">{([
      ...
      { label: 'Upcoming 7d', value: aggregates?.upcoming_7d ?? 0, accent: aggregates?.upcoming_7d ? 'border-l-blue-500' : 'border-l-[rgb(var(--color-border-200))]', num: aggregates?.upcoming_7d ? 'text-blue-700' : 'text-[rgb(var(--color-text-400))]', hint: aggregates?.upcoming_7d ? 'click to filter' : 'quiet week ahead', win:'week' as const },
