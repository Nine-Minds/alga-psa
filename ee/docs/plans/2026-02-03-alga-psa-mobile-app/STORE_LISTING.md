...
- Browse your ticket queue with fast search and filters.
- Open a ticket to view key details and the latest conversation.
...
ticketing, helpdesk, service desk, msp, psa, it support

## Category

Business / Productivity (final selection TBD)

## Privacy / data notes (high level)

- Auth tokens are stored in OS secure storage.
- The app avoids logging or transmitting sensitive ticket/comment content to analytics.
