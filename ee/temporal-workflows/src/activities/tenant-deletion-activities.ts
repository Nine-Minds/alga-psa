...
const TENANT_TABLES_DELETION_ORDER: string[] = [
  ...
  'ticket_conversation_email_routes', 'ticket_conversation_email_operations', 'ticket_conversation_sender_grants', 'ticket_conversation_publications', 'ticket_conversation_editor_drafts',
