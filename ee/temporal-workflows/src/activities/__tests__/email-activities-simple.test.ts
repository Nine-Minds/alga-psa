...
describe('Email Activities - Simple Tests', () => {
  ...
  describe('MockEmailService', () => {
    ...
    it('should return email templates for testing', async () => {
  ...
  describe('Email Service Factory', () => {
    ...
    it('should throw error for unknown providers', async () => {
      await expect(createEmailService({ provider: 'unknown' as any })).rejects.toThrow('Unknown email provider: unknown');
    });
