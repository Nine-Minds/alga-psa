...
pub const CAP_INVOICE_MANUAL_CREATE: &str = "cap:invoice.manual.create";
pub const CAP_CLIENT_READ: &str = "cap:client.read";
pub const CAP_SERVICE_READ: &str = "cap:service.read";
