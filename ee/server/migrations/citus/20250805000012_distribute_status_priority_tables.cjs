/**
 * Distribute status, priority, and related configuration tables
 */
...
exports.up = async function(knex) {
  ...
  console.log('Distributing status and priority tables...');
  ...
  console.log('\n✓ All status and priority tables distributed successfully');
};
...
exports.down = async function(knex) {
  ...
  console.log('Undistributing status and priority tables...');
