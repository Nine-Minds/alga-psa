/**
 * Distribute workflow management tables
 */
const { 
...
exports.up = async function(knex) {
  ...
  console.log('Distributing workflow management tables...');
  ...
  console.log('\n✓ Workflow management tables distribution completed');
};
...
exports.down = async function(knex) {
  ...
  console.log('Undistributing workflow management tables...');
