...
function throwSafeCredentialSaveError(operation: 'create' | 'update', error: unknown, details: { tenant: string; userId: string; clientId?: string; credentialId?: string; source?: string }): never {
